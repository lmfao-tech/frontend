      ...
      <div className="sticky top-0 h-screen overflow-auto dark:bg-slate-800">
        {session ? (
          <div className="flex min-h-screen flex-col mb-20">
            <div className="flex group items-center px-6 py-3 mx-5 mt-5 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700 hover:cursor-pointer">
            ...
            <div className="flex px-8 py-8 items-center justify-center fixed bottom-0 right-0 z-10 bg-white dark:bg-slate-800">
              {/* Create button fixed to the bottom */}
              <div className="flex flex-col items-center justify-center h-10 w-80 lg:w-80 ">
                <Link
                  href="/create"
                  as={`/create`}
                  passHref={true}
