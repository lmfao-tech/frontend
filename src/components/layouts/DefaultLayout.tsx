    ...
    <div>
      <AnimatePresence>
        ...
        {helpOpen && (
          ...
          <div className="fixed p-10 lg:p-72 z-[1000] bg-black/20 flex justify-center items-center w-screen h-screen">
            <motion.div initial={{ scale: 0 }} exit={{ scale: 0, opacity: 0 }} animate={{ scale: 1 }} className={`relative overflow-y-auto scrollbar-thin w-screen z-[1001] rounded-md h-[60vh] ${isDarkMode ? "bg-gray-600 text-white": "bg-gray-400"}`}>
              
              <button onClick={() => setHelpOpen(false)} className="focus:bg-gray-500 hover:bg-gray-500 p-1 rounded absolute top-o right-0 mt-3 mr-3">
              ...
              <div className="p-5 lg:pt-7">
                ...
                <div className="flex flex-col lg:flex-row mt-5 flex-wrap gap-1">
                  <div className={`flex-1 rounded-md p-3 border-2 ${isDarkMode ? "border-gray-700" : ""}`}>
                    <h2 className={`text-center font-bold text-lg px-3 py-1 rounded-md ${isDarkMode ? "bg-gray-700" : ""}`}>
                      HAHA coins
                    </h2>
