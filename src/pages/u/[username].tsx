...
function UserProfile({ u }: any) {
  ...
  let {
    ...
    hasMore,
    meta
  }: { memes: Post[]; loading: boolean; hasMore: boolean, meta: any } = usePostFeed({
  ...
  return (
    <div className="grid lg:grid-cols-6">
      ...
      <div className="col-span-4 bg-[#e2e8f0] dark:bg-[#101010] text-white min-h-screen w-full">
      ...
      <div className="hidden lg:block dark:text-white sticky top-0 h-screen w-full col-span-2">
        <div className="">
          {/* Display the user object*/}
          {user && (
            <User
    ...
    <div className="flex flex-col justify-center items-center py-10 w-full">
      ...
      <div className="flex flex-col gap-2 justify-center items-center w-full">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <span className="text-gray-400 text-md">{meta.total} memes posted</span>
        </div>
      </div>
      ...
      <div className="flex gap-10 h-30 jusity-center items-center mt-14">
        ...
        <button data-tip="Click to switch between current & longest streak" onClick={() => setLorC((prev) => !prev)} className="flex flex-col items-center justify-center text-lg text-center dark:text-slate-200">
