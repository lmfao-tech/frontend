...
function tos() {
  return (
    <div className="mx-5 mt-10 mb-20 md:mb-0 dark:text-white">
      <strong className="font-serif text-2xl">Terms &amp; Conditions</strong>{" "}
      <p>
        By downloading or using the app on the web, these terms will automatically apply to
      ...
      <p>
        Dhravya Shah is committed to ensuring that the app is as useful and
      ...
      <p>
        The LMFAO.tech app stores and processes personal data that you have
        ...
        features and it could mean that the LMFAO.tech app won’t work properly
        or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Dhravya Shah will
        ...
        Wi-Fi or provided by your mobile network provider, but Dhravya Shah
      ...
      <p>
        Along the same lines, Dhravya Shah cannot always take responsibility for
        ...
        avail the Service, Dhravya Shah cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Dhravya Shah’s responsibility for your use of the app,
        ...
        it available to you. Dhravya Shah accepts no liability for any loss,
      ...
      <p>
        ...
        using the app. Dhravya Shah does not promise that it will always update
      ...
      <p>These terms and conditions are effective as of 2022-08-15</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at dhravyashah@gmail.com.
      </p>{" "}
    </div>
  );
}
tos.getLayout = (page: ReactElement) => {
