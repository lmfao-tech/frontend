...
function privacy() {
  return (
    <div className="mx-5 mt-10 mb-20 dark:text-white md:mb-0">
      <strong className="font-serif text-2xl">Privacy Policy</strong>{" "}
      <p>
        Dhravya Shah built the LMFAO.tech app as a Free app. This SERVICE is
        provided by Dhravya Shah at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at LMFAO.tech unless
      ...
      <p>
        ...
        but not limited to Dhravya Shah. By logging into the app, you agree to
        the collection of information of your twitter handle, and your email
        address. Other than that, this service collects the number of points and
        the posts liked or made by the user, for the core functionality of the
        app. Usage analytics are collected completely anonymously. No login
        tokens are stored in our servers. All session data is stored in the
        users&apos; device.
      </p>{" "}
      <div>
        <p>
      ...
      <p>This policy is effective as of 2022-08-15</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at dhravyashah@gmail.com.
      </p>
    </div>
  );
}
